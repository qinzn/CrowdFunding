...
<script type="text/javascript">
    ...
    $("#leftToRightBtn").click(function () {
        var selectedOptiopns = $("#leftRoleList option:selected");

        var jsonObj = {
            userid: "${param.id}"
        };

        $.each(selectedOptiopns, function (i, n) {
        ...
        $.ajax({
            ...
            success: function (result) {
                layer.close(index);
                if (result.success){
                    $("#rightRoleList").append(selectedOptiopns.clone());
                    selectedOptiopns.remove();
                }else {
    ...
    $("#rightToLeftBtn").click(function () {
        var selectedOptiopns = $("#rightRoleList option:selected");
        ...
        $.ajax({
            ...
            success: function (result) {
                layer.close(index);
                if (result.success){
                    $("#leftRoleList").append(selectedOptiopns.clone());
                    selectedOptiopns.remove();
                }else {
                    layer.msg(result.message, {time: 1000, icon: 5, shift: 6})
                }
